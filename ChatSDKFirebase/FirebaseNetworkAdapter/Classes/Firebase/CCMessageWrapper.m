...
-(NSMutableDictionary *) threadData {
    NSDictionary * dict = @{bReadPath: self.initialReadReceipts};
...
-(void) markMessageAsRead {
    ...
    [ref updateChildValues:[self threadData]];
}
...
-(NSMutableDictionary *) serialize {
    NSDictionary * dict = @{bType: _model.type,
                             ...
                             bReadPath: self.initialReadReceipts, //self.readStatus ?? self.initialReadReceipts,
...
//             [_model setReadStatus:readReceipts]
            ...
            bMessageReadStatus currentStatus =  [_model readStatusForUserID:user.entityID];
            readReceipts[user.entityID] = @{bStatus: @(currentStatus), bDate: FIRServerValue.timestamp};
        } else {
