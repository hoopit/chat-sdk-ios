...
-(void) updateGroupName {
    ...
    FIRDatabaseReference * ref = [FIRDatabaseReference threadNameRef:_model.entityID];
    FIRDatabaseReference * metaRef = [FIRDatabaseReference threadMetaRef:_model.entityID];
    [ref updateChildValues:[self getThreadName]];
    [metaRef updateChildValues:[self getThreadName]];
}
...
-(NSMutableDictionary *) getThreadName {
    NSDictionary * dict =  @{bUserNameKey: [NSString safe:_model.name]};
